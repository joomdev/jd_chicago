	...
	<div id="footer">
		<div class="container">
			<p class="muted credit pull-left">
				Copyright &copy; 2009 &ndash; <?php echo date('Y') ?> JoomDev.  For support about the template and the QuickStart package please <a href="http://www.joomdev.com/forum" target="_blank">click here</a>. <br/>
				QuickStart is powered by Akeeba Backup technology but is not affiliated with or endorsed by Akeeba Ltd. For any questions about the QuickStart and the template please on our <a href="http://www.joomdev.com/forum" target="_blank"> Forum </a>.<br>
