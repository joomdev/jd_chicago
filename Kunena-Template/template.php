 ...
 * @since  K4.0
 */
class KunenaTemplatejd_chicago extends KunenaTemplate
{
	/**
	 ...
	 * @var array
	 */
	protected $default = array('jd_chicago');
	...
	public function initialize()
	{
		...
		$filename1 = JUri::root() . 'components/com_kunena/template/jd_chicago/assets/css/kunena.css';
		JFactory::getDocument()->addStyleSheet($filename1);
		
		$filename = JPATH_SITE . '/components/com_kunena/template/jd_chicago/assets/css/custom.css';
