...
<form action="<?php echo JURI::root(true); ?>/index.php" method="post" id="comment-form" class="form-validate">
	...
	<div class="row">
		<div class="name-form col-xs-6 col-sm-4">
		...
		<div class="email-form col-xs-6 col-sm-4">
		...
		<div class="url-form col-xs-6 col-sm-4">
	...
	<input type="submit" class="button btn btn-2" value="<?php echo JText::_('K2_SUBMIT_COMMENT'); ?>" />
