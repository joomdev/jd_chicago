	...
	<i class="fa fa-comments-o" aria-hidden="true"></i>
		...
		<?php else: ?>
			...
			<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
				<?php echo $this->item->numOfComments; ?> <?php echo ($this->item->numOfComments>1) ? JText::_('Comments') : JText::_('Comments'); ?>
			</a>
			<?php else: ?>
			<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
...
<?php /* ?>
	...
	<div class="catItemReadMore">
		<a class="k2ReadMore btn btn-2" href="<?php echo $this->item->link; ?>">
